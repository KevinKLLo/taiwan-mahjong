...
- [x] 2.1 Core 先 Red 再 Green：摸打、胡牌、補花、AI、合法性與多局守恆測試通過，提交 core 分支。
- [x] 2.2 UI 完成四方牌桌及全部狀態，操作測試與 Browser fixtures 驗收通過，提交 ui 分支。
- [x] 2.3 Desktop 完成隔離殼、打包與權限邊界測試，提交 desktop 分支。
